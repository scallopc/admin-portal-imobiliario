...
import { Phone, MessageSquare, Calendar, User, Clock, AlertCircle, Send, RefreshCw, Loader2 } from 'lucide-react'
...
export function FollowUpDashboard() {
  ...
  const getPriorityColor = (nextContact: string) => {
    const daysDiff = Math.ceil(
      (new Date().getTime() - new Date(nextContact).getTime()) / (1000 * 60 * 60 * 24)
    )
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold mb-2">Nenhum follow-up pendente!</h3>
            <p className="text-muted-foreground">
              Todos os leads estão em dia com o cronograma de contato.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                {data.total} leads precisam de follow-up
              </CardDescription>
            </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => handleAction(lead.id, 'qualified')}
                      >
