...
export function ChipAutocomplete({
  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
       <div className="flex flex-wrap gap-2 p-2 border border-input rounded-md bg-background min-h-full focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
        {value.map((chip, index) => (
         ...
         <Input
           ...
           className="flex-1 min-w-[200px] border-0 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 h-auto px-0 py-0"
           disabled={disabled}
         />
      </div>
